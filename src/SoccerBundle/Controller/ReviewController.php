...
class ReviewController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reviews = $em->getRepository('SoccerBundle:Review')->findAll();
    ...
    {
        $review = new Review();
        $form = $this->createForm('SoccerBundle\Form\ReviewType', $review);
    ...
    {
        $deleteForm = $this->createDeleteForm($review);
        $editForm = $this->createForm('SoccerBundle\Form\ReviewType', $review);
